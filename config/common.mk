...
# OTA Updater
CANDY_BASE_URL    := https://basketbuild.com/devs/CandyRoms
CANDY_DEVICE_URL  := $(CANDY_BASE_URL)/$(TARGET_DEVICE)
...
export CANDY_OTA_VERNAME=$(CANDY_VERSION)
export CANDY_OTA_VER=$(CANDY_OTA_VERSION)
export CANDY_OTA_URL=$(CANDY_DEVICE_URL)/$(CANDY_VERSION).zip
